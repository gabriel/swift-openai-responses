...
public enum Item: Equatable, Hashable, Sendable {
	...
	///
	/// Can contain text, images, and audio inputs, as well as previous assistant responses and tool call outputs.
	@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Input: Equatable, Hashable, Sendable, Codable {
	...
	@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Output: Equatable, Hashable, Sendable, Codable {
		/// The content of the output message.
		@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Content: Equatable, Hashable, Sendable, Codable {
			/// An annotation of the text output.
			@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Annotation: Equatable, Hashable, Sendable, Codable {
	...
	///
	/// See the [function calling guide](https://platform.openai.com/docs/guides/function-calling) for more information.
	@Codable @CodingKeys(.snake_case) public struct FunctionCall: Equatable, Hashable, Sendable, Codable {
	...
	///
	/// See the [function calling guide](https://platform.openai.com/docs/guides/function-calling) for more information.
	@Codable @CodingKeys(.snake_case) public struct FunctionCallOutput: Equatable, Hashable, Sendable, Codable {
	...
	@Codable @CodingKeys(.snake_case) public struct ComputerToolCall: Equatable, Hashable, Sendable, Codable {
		/// The action of the computer call.
		///
		/// See the [computer action guide](https://platform.openai.com/docs/guides/tools-computer-use) for more information.
		@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Action: Equatable, Hashable, Sendable, Codable {
			/// A click action.
			///
	...
	@Codable @CodingKeys(.snake_case) public struct ComputerToolCallOutput: Equatable, Hashable, Sendable, Codable {
	...
	public struct Reasoning: Equatable, Hashable, Codable, Sendable {
		...
		@Codable @CodedAt("type") public enum Summary: Equatable, Hashable, Sendable, Codable {
